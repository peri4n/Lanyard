...
/** Function representing the logarithm of the gamma function. */
object LogGamma extends Function[Double, Double] {
  ...
  def apply( value: Double ): Double = {
    ...
    require( 0 < value , "Argument of LogGamma needs to be strictly positive. Found value: " + value )
